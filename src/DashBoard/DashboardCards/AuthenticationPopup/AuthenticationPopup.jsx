    ...
    // <div className="w-[527px] h-[240px] rounded-[30px] bg-[#141518] p-[50px] ml-3">
       <div className="flex flex-col items-center text-center  ">
         ...
         <div className="flex gap-10 mt-12">
             ...
             <button onClick={()=>navigate('/Home/LessonSelectedModuleAfter')} className="bordershadow w-[200px] h-[36px] bg-[#34A853]">Save & Publish Module</button>
         </div>
       </div>
    //  </div>
  )
...
//         <div className="flex gap-10 mt-12">
//             <button className="bordershadow w-[138px] h-[36px]">Close</button>
//             <button onClick={()=>navigate('/Home/LessonsWithAssessment')} className="bordershadow w-[200px] h-[36px] bg-[#34A853]">Save & Publish Module</button>
//         </div>
//       </div>
//     </div>
//   );
